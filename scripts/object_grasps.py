...
caffe_root = '/home/alienbob/caffe/'  # replace this with the location of your Caffe folder
...
image_sub = rospy.Subscriber("/camera/depth/image_raw", Image, imageCallback)
